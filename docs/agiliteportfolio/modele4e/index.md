...
| --- | --- | --- | --- | --- |
| **Intention** | Tester 5 prototypes IA | Piloter la domotique (100 foyers) | Optimiser les capteurs industriels | Se retirer de la solution RSE |
| **Cadence** | Itérations toutes les 4 à 8 semaines | Montée en charge en 3–6 mois | Ajustements trimestriels | Processus continu de retrait |
| **Défi / Tension** | Incertitude ↔ Priorisation | Standardisation ↔ Flexibilité | Optimisation ↔ Stagnation | Désengagement ↔ Résistance |

**Comment lire ce tableau ?**

- **Intention** : quel objectif poursuivons-nous ?
- **Cadence** : à quel rythme la décision évolue-t-elle ?
- **Défi** : quelle tension majeure doit être gérée ?
...
Dans cette zone, le but est de démontrer la viabilité du modèle d’affaires à petite échelle. On cherche encore notre stratégie. L’approche est très tactique et opportuniste. La performance est mesurée par l’atteinte d’objectifs tactiques.
...
Le modèle A4E ne décrit pas des cases statiques, mais le **cycles de vie des initiatives stratégiques :**
...
> Une organisation équilibrée vit toutes les saisons. Il ne s’agit pas de tout faire mûrir en même temps. Il s’agit de synchroniser les rythmes.
> 
...
- **Appeler Expansion ce qui est en fait un MVP mal ficelé.**
