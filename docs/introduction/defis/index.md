...
![Les tensions organisationnelles clés d’une entreprise (*adapté de Bouchkhi, 1998)*](image.png)
...
3. **Non linéaire** → de petits changements locaux peuvent produire des effets globaux, l’effet papillon.
4. **Émergent** → le résultat d’ensemble est non prévisible à partir de celui des parties.
...
- **Le design thinking** : méthode collaborative centrée sur l’utilisateur, favorisant l’émergence de solutions innovantes à travers le prototypage et l’itération.
