...
❓ **Être réactif, c’est pouvoir répondre à ces questions :** - Votre organisation est-elle capable de modifier ses priorités en cas d’urgence ? - Disposez-vous de processus intégrés pour gérer efficacement les imprévus ?

> C’est passer de **Subir les urgences et les crises**
à **Gérer les opportunités sans les subir**
> 

*Par exemple, une DSI a décidé de supprimer le processus d’escalade en crise et donner mandat direct aux Product Owners.*
...
> C’est passer de **Perdre des opportunités à cause d’une organisation rigide**
à **Ajuster l’organisation sans tout bouleverser**
> 
...
> C’est passer de **Se laisser dépasser par l’évolution du marché**
à **Faire évoluer l’entreprise sur le long terme**
> 
...
> C’est passer de **Être condamné à suivre plutôt qu’à innover**
à **Anticiper et être acteur du changement**
> 
...
Les 4 capacités ne doivent pas être développées de manière indépendante. Elles forment un **système intégré**, où chacune renforce les autres. Car ce sont quatre stratégies de réponse différentes face au changement incrémental et continu, et à la gestion du risque et de l’incertitude.
...
🔹**La chaîne de valeur** : attentes des clients, évolutions du marché.

🔹**L’organisation** : processus internes, structure organisationnelle.

⚠️ L’entreprise agile n’est pas un synonyme d’organisation apprenante, mais elle a besoin de l’apprentissage pour être agile.  C‘est une organisation capable de structurer son apprentissage pour apprendre plus vite et mieux.
...
| **Slack en temps** | Marges dans les plannings et cycles de travail | Favorise l’expérimentation et l’apprentissage |
